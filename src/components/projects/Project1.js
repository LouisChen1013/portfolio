              ...
              <section className="s3">
                ...
                <div className="main-context">
                  ...
                  <p>
                    ...
                    programs, and generate documents (Student Catalogue)
                    required.
                  </p>
                  <h5>Key Features: </h5>
                  <ul>
                  ...
                  <div className="img-container">
                    <img
                      src={
                        process.env.PUBLIC_URL + "/images/BCIT_SOCAS/dash.png"
                      }
                      alt="dashboard"
                    />
                  </div>
                  ...
                  <div className="img-container">
                    <img
                      src={
                        process.env.PUBLIC_URL +
                        "/images/BCIT_SOCAS/feedback.png"
                      }
                      alt="feedback"
                    />
                  </div>
                  ...
                  <div className="img-container">
                    <img
                      src={
                        process.env.PUBLIC_URL +
                        "/images/BCIT_SOCAS/add_user.png"
                      }
                      alt="add_user"
                    />
                  </div>
