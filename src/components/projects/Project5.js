              ...
              <section className="s3">
                ...
                <div className="main-context">
                  ...
                  <p>
                    ...
                    the frontend and Django for the backend. It provides a
                    simple and easy-to-use interface for users to enjoy shopping
                    online. It purposely does not include every conceivable
                    feature of an e-commerce website; instead, Demoshop aims to
                    provide core features that most e-commerce websites have.
                    The website is hosted on Heroku and has AWS RDS&S3 to hold
                    the database/files.
                  </p>
                  <h5>Key Features: </h5>
                  <ul>
                    <li>Full-featured shopping cart</li>
                    <li>User registration & login portal</li>
                  ...
                  <div className="img-container">
                    <img
                      src={
                        ...
                        "/images/ecommerce/ecom_main.png"
                      }
                      alt="home_page"
                    />
                  </div>
