...
const Chat = () => {
  ...
  return (
    <div className="project">
      <img
        className="thumbnail"
        src={process.env.PUBLIC_URL + "/images/chatbox/main.png"}
        alt="home"
      />
            ...
            <section className="s3">
              ...
              <div className="main-context">
                ...
                <div className="img-container">
                  <img
                    src={
                      process.env.PUBLIC_URL + "/images/chatbox/chat_room.png"
                    }
                    alt="chat_room"
                  />
                </div>
                ...
                <div className="img-container">
                  <img
                    src={process.env.PUBLIC_URL + "/images/chatbox/join.png"}
                    alt="join"
                  />
                </div>
                <div className="img-container">
                  <img
                    src={process.env.PUBLIC_URL + "/images/chatbox/leave.png"}
                    alt="leave"
                  />
                </div>
                ...
                <div className="img-container">
                  <img
                    src={process.env.PUBLIC_URL + "/images/chatbox/chat.png"}
                    alt="chat"
                  />
                </div>
                <div className="img-container">
                  <img
                    src={
                      ...
                      "/images/chatbox/share_location.png"
                    }
                    alt="share_location"
                  />
                </div>
                ...
                <div className="img-container">
                  <img
                    src={
                      process.env.PUBLIC_URL +
                      "/images/chatbox/leave_confirm.png"
                    }
                    alt="leave_confirm"
                  />
                </div>
                <div className="img-container">
                  <img
                    src={
                      process.env.PUBLIC_URL + "/images/chatbox/join_error.png"
                    }
                    alt="join_error"
                  />
                </div>
