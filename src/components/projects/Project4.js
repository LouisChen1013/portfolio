  ...
  return (
    <div>
      <div className="project">
        <img
          className="thumbnail"
          src={process.env.PUBLIC_URL + "/images/foodoor/foodoor_main.jpg"}
          alt="main"
        />
            ...
            <Modal.Body className="px-0 py-0">
              <section className="s3">
                ...
                <div className="main-context">
                  ...
                  <h5>Objective:</h5>
                  <p>
                    This project is aimed to build a food ordering service
                    (e.g., Uber, DoorDash, Foodpanda, and ..etc) on a mobile
                    device. Foodoor is a simple service to order food from a
                    variety of restaurants online. Enjoy your favourite dishes
                    across different cuisines and flavours delivered to your
                    door step.
                  </p>
                  <h5>Key Features: </h5>
                  <ul>
                    <li>User login/logout/registration</li>
                  ...
                  <h5>
                    Search food/restaurant by keyword & Sort restaurants by
                    rating or cost
                  </h5>
                  <div className="food-img-container">
                    <div>
